...
import { ChevronDown, Menu, X, Search, Command, ExternalLink, Home, User, Briefcase, Camera, Mail } from 'lucide-react';
import AnimatedCaveLogo from '../branding/AnimatedCaveLogo';
import CommandMenuToggle from '../command/CommandMenuToggle';

// Navigation data structure
const NAV_SECTIONS = [
  { label: 'Home', to: '/', icon: Home, description: 'Landing zone' },
  { label: 'The Vault', to: '/side-projects', icon: Briefcase, description: 'Side projects and experiments' },
  { label: 'Studio', to: '/studio', icon: Camera, description: 'Masonry photography & design gallery' },
  { label: 'Bio', to: '/about', icon: User, description: 'Cinematic resume' },
  { label: 'Contact', to: '/contact', icon: Mail, description: 'Get in touch' },
];

const QUICK_ACTIONS = [{ label: 'Download Bio', to: '/about', cta: true }];
