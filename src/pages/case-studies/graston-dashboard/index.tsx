...
const MarketingCommandCenter = lazy(
  () => import('../../../components/dashboard/MarketingCommandCenter')
);
...
const GrastonDashboard: React.FC = () => {
  return (
    <CaseStudyLayout>
      <HeroSection
        title={data.title}
        backgroundImage="/images/case-studies/graston-dashboard/cover.svg"
      />
      <Overview role={data.role} tools={data.tools} duration="6 months" summary={data.summary} />
