...
export const technologyStacks: TechnologyStack[] = [
  ...
  },
  {
    ...
    icon: '🛡️',
    technologies: ['Cloudflare', 'Netdata', 'Wordfence', 'Sucuri', 'Cloudflare Tunnel'],
  },
  {
  ...
  },
  {
    ...
    icon: '🌐',
    technologies: ['Google Ads', 'Meta Ads', 'LinkedIn Ads', 'PixelYourSite Pro', 'OptinMonster'],
  },
  {
    category: 'E-commerce',
    icon: '💳',
    technologies: ['WooCommerce', 'Stripe', 'PayPal', 'Easy Digital Downloads', 'MemberPress'],
  },
  {
    category: 'Hosting & Infrastructure',
    icon: '🖥️',
    technologies: ['Liquid Web', 'Vercel', 'Netlify', 'Apache', 'Nginx', 'PHP-FPM'],
  },
  {
  ...
  },
  {
    ...
    icon: '💻',
    technologies: ['PHP', 'JavaScript', 'TypeScript', 'jQuery', 'SQL', 'CSS/SCSS', 'HTML'],
  },
  {
    category: 'Frontend Development',
    icon: '🚀',
    technologies: ['React', 'Framer Motion', 'Tailwind CSS', 'Bootstrap', 'Webpack', 'Vite'],
  },
  {
    category: 'Backend & APIs',
    icon: '🔌',
    technologies: ['Node.js', 'Express', 'REST APIs', 'Webhooks', 'Cloudflare Workers'],
  },
  {
    category: 'Development Tools',
    icon: '🛠️',
    technologies: ['Git/GitHub', 'VS Code', 'GitHub Actions', 'Postman', 'Chrome DevTools'],
  },
  {
  ...
  },
  {
    ...
    icon: '📋',
    technologies: ['Notion', 'Asana', 'Trello', 'Slack', 'Microsoft Teams'],
  },
  {
  ...
  },
  {
    category: 'Database',
    icon: '💾',
    technologies: ['MySQL', 'phpMyAdmin', 'PostgreSQL', 'Redis', 'MongoDB'],
  },
];
