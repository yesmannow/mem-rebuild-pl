...
export const labItems: LabItem[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    tagline: 'Executive Dashboard & Revenue Intelligence Platform',
    techStack: [
      { name: 'React', reason: 'Component-driven architecture enables rapid iteration on complex data visualizations and real-time metric updates' },
      { name: 'Recharts', reason: 'D3-based charting library chosen for declarative data visualization with minimal overhead and responsive design' },
      { name: 'Zustand', reason: 'Lightweight state management for real-time data synchronization across dashboard widgets without prop drilling' },
      { name: 'REST API', reason: 'Unified API layer aggregates data from multiple sources (CRM, analytics, marketing platforms) for consolidated reporting' },
    ],
    context: {
      problem: 'Marketing leaders lack real-time visibility into revenue performance, making it difficult to make data-driven decisions. Metrics are scattered across multiple tools, requiring manual compilation and leading to delayed insights.',
      solution: 'Built a unified executive dashboard that aggregates revenue metrics, campaign performance, and pipeline health into a single, real-time view. The platform connects to CRM, marketing automation, and analytics tools to provide comprehensive revenue intelligence.',
      impact: 'Reduced reporting time from 8 hours to 15 minutes weekly. Enabled real-time decision-making that improved campaign ROI by 34%. Executive alignment increased through transparent, accessible metrics.',
      target: 'CMOs, Marketing VPs, Revenue Operations Leaders, Executive Teams',
      usage: 'Accessed via web dashboard or embedded in internal tools. Auto-refreshes every 15 minutes with configurable alerts for key metric thresholds. Export capabilities for board presentations.',
    },
  ...
  },
  {
    ...
    techStack: [
      { name: 'React', reason: 'Component-based architecture enables modular tool development with shared state and smooth transitions.' },
      { name: 'TypeScript', reason: 'Type safety prevents calculation errors and ensures data integrity across complex financial models.' },
      { name: 'Recharts', reason: 'D3-based charting library for interactive visualizations of budgets, pipelines, and burn rates.' },
      { name: 'Framer Motion', reason: 'Smooth tab transitions and micro-interactions enhance the professional user experience.' },
    ],
    context: {
      problem: 'Marketing leaders struggle with static spreadsheets that fail to capture channel volatility, growth scenarios, and complex budget interdependencies. Annual planning takes weeks and lacks executive-ready visualizations.',
      solution: 'Built a comprehensive simulator with 6 interactive tools: Budget Planner, Headcount Modeler, Media Mix Optimizer, Experimentation Budget, Pipeline Visualizer, and Burn Rate Calculator. Each tool provides real-time calculations with professional charts.',
      impact: 'Reduced annual planning cycles from 3 weeks to 4 days. Aligned marketing and finance forecasts through shared modeling. Enabled data-driven decision making for channel investments and headcount planning.',
      target: 'CMOs, Marketing VPs, RevOps Leaders, CFO Partners, Finance Teams',
      usage: 'Web-based platform with tab navigation between tools. Model scenarios, adjust inputs with sliders, visualize outcomes with charts, and export executive-ready reports.',
    },
    link: '/apps/marketing-simulator',
  },
  {
    id: 'license-hub',
    title: 'License Hub',
