...
const PersonSchema: React.FC = () => {
  const schemaData = {
    ...
    description:
      'Creative Technologist and Marketing Strategist integrating strategy, design, and motion. Specializing in marketing automation, web development, and systems architecture.',
