...
export const OceanAuroraBackground = ({
  ...
  if (prefersReducedMotion || isMobile) {
    return (
      <main>
        <div
          className={cn(
            "relative flex min-h-[100vh] flex-col items-center justify-center bg-gradient-to-br from-[#edf6f9] via-[#83c5be] to-[#006d77] text-[#006d77] dark:text-[#edf6f9] dark:from-[#005a63] dark:via-[#006d77] dark:to-[#003d44]",
            className,
          )}
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex min-h-[100vh] flex-col items-center justify-center bg-[#edf6f9] text-[#006d77] dark:bg-[#005a63]",
          className,
        )}
        {...props}
      >
