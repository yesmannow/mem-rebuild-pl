...
export interface OceanBackgroundBeamsProps {
  className?: string;
}
        ...
        >
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                <stop stopColor="#83c5be" stopOpacity="0" />
                <stop stopColor="#83c5be" />
                <stop offset="32.5%" stopColor="#006d77" />
            ...
            >
              <stop offset="0.0666667" stopColor="#83c5be" />
              <stop offset="0.243243" stopColor="#83c5be" />
              <stop offset="0.43594" stopColor="#edf6f9" stopOpacity="0" />
            </radialGradient>
          </defs>
        </svg>
      </div>
...
OceanBackgroundBeams.displayName = "OceanBackgroundBeams"
