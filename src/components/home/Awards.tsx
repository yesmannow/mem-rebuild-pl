      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Celebrating excellence in creative achievement — honoring the foundation of visual
            storytelling that continues to inspire innovative design solutions.
          </p>
        </motion.div>
          ...
          <div className="relative z-10 p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-2 text-center lg:text-left">
                ...
                >
                  Awarded to Jacob Darling for outstanding achievement in photography — recognizing
                  artistic excellence, originality, and technical mastery in the Regional Scholastic
                ...
                >
                  <p className="text-sm text-yellow-200 italic">
                    <strong className="text-yellow-400">Significance:</strong> The Gold Key is the
                    top regional honor in the Scholastic Art Awards, placing recipients in the top
                    5% of emerging artists nationwide.
                  </p>
                </motion.div>
              </div>
            </div>
