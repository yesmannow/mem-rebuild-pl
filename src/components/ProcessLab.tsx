...
const processSteps = [
  {
    ...
    details:
      'Each letterpress project begins with careful consideration of the message and the medium. We select typefaces that not only look beautiful but also print well under pressure.',
  ...
  },
  {
    ...
    details:
      'This is where the magic happens. Each piece of type is placed individually, creating a tactile layout that will be impressed into paper. Precision is key - a single misaligned letter can ruin the entire print run.',
  ...
  },
  {
    ...
    details:
      'The ink must be applied evenly and consistently. Too much ink creates blobs, too little results in faint impressions. We use traditional oil-based inks that provide rich, deep color.',
  ...
  },
  {
    ...
    details:
      'The moment of truth. The paper is fed through the press, and under tremendous pressure, the type impresses itself into the paper. Each sheet is a unique piece of art.',
  ...
  },
  {
    ...
    details:
      'After printing, pieces are trimmed to size, folded if needed, and given any final embellishments. This step ensures the final product is as perfect as the printing process.',
