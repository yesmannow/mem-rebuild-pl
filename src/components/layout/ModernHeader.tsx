            ...
            <div className="flex items-center gap-6">
              {mainNav.map(item => (
                ...
                >
                  ...
                  >
                    <span
                      className={`transition-colors duration-300 ${pathname === item.to ? 'text-blue-400' : 'text-white/60 group-hover:text-blue-400'}`}
                    >
                      {item.icon}
                    </span>
                  ...
                  >
                    <span
                      className={
                        action.primary
                          ? 'text-white'
                          : 'text-white/80 group-hover:text-blue-400 transition-colors'
                      }
                    >
                      {action.icon}
                    </span>
                ...
                {quickActions.map((action, index) => (
                  ...
                  >
                    ...
                    >
                      <span
                        className={
                          action.primary ? 'text-white' : 'text-white/80 group-hover:text-blue-400'
                        }
                      >
                        {action.icon}
                      </span>
