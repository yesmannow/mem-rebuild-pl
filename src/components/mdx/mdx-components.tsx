...
const components = {
  ...
  ol: (props: any) => <ol className="list-decimal list-inside mb-4 space-y-2 opacity-90" {...props} />,
  li: (props: any) => <li className="ml-4" {...props} />,
  a: (props: any) => <a className="text-[color:theme('colors.cave.ember')] hover:underline" {...props} />,
